...
public class CartController {
    ...
    public ResponseEntity<Void> addItems(@PathVariable Long userID, @Valid @RequestBody List<OrderItemDto> items) {
        cartManager.addToCart(userID, items);
        return ResponseEntity.noContent().build();
    }

    @PostMapping("/{userID}/item")
    public ResponseEntity<Void> addItem(@PathVariable Long userID, @Valid @RequestBody OrderItemDto item) {
        cartManager.addToCart(userID, List.of(item));
        return ResponseEntity.noContent().build();
    }

    @PutMapping("/item")
    public ResponseEntity<Void> updateItem(@Valid @RequestBody OrderItemDto item) {
    ...
    public ResponseEntity<List<OrderItemDto>> getItems(@PathVariable Long userID) {
    ...
    public ResponseEntity<List<OrderItemDto>> getItemsByCartID(@PathVariable Long cartID) {
